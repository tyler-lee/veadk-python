...
try:
    ...
    if sys.version_info < (3, 11):
        raise ImportError(
            "TrustedMCP MCP Tool requires Python 3.11 or above. Please upgrade your Python version."
        ) from e
    else:
        raise e
...
class TrustedMcpToolset(McpToolset):
    ...
    @classmethod
    def from_config(
        cls: type[TrustedMcpToolset], config: ToolArgsConfig, config_abs_path: str
    ) -> TrustedMcpToolset:
        """Creates an TrustedMcpToolset from a configuration object."""
